package com.example.acer.msic.host;
...
import com.example.acer.msic.host.ServerDeviceListFragments.HostFragmentListener;

import java.io.File;

public class HostActivity extends Activity implements ChannelListener,
        HostFragmentListener
{
    public final static int HOST_MODE = 15;

    public static final String TAG = "Host Mode Activity";
    ...
    {
        ServerDeviceListFragments fragmentList = (ServerDeviceListFragments) getFragmentManager()
                .findFragmentById(R.id.frag_host_devices);
     ...
     *
     * @see
     * com.skapps.musicaround.dj.ServerDeviceListFragments.DJFragmentListener
     * #cancelDisconnect()
     */
    @Override
    public void cancelDisconnect()
    {
        ...
        if (manager != null)
        {
            ...
            final ServerDeviceListFragments fragment = (ServerDeviceListFragments) getFragmentManager()
                    .findFragmentById(R.id.frag_host_devices);
     ...
     *
     * @see
     * com.example.musicsaround.dj.ServerDeviceListFragments.DJFragmentListener
    ...
    public void connect(WifiP2pConfig config)
    {
        ...
        newConfig.groupOwnerIntent = HOST_MODE;
